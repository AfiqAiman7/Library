...
<div class="contactUs">
	...
	<div class="box">
					...
					<form method="POST" action="registerstaff.php">
						<div class="formBox">
							...
							<div class="row50">
								...
								<div class="inputBox">
									<span>Branch</span>
									<input type="text" name="branch" placeholder="Enter Staff Branch" autocomplete="off">
								</div>
							</div>
                ...
                <div class="inputBox">
							...
							<div class="inputBox">
									<span>Type</span>
									<select name="typeUser" class="option" placeholder="Choose User Type" required>
                   	<option name="typeUser" value="Staff">Staff 
                 		<option name="typeUser" value="Head Department">Head Department
                 	</select>
								</div>
							<div class="row100">
								<div class="inputBox">
