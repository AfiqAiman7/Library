...
<html lang="en">
	<head>
		...
		<title> Library Menu Page </title>
		<link rel="stylesheet" href="MyCss.css">
	</head>
	<body>
		<header>
			<!--Navigation//-->
			<a href="#" class="logo">ONLINE LIBRARY SYSTEM</a>
		...
		<section class="banner" id="home">
			<div class="textBx">
				<h2>WELCOME<br><span> NEGERI SEMBILAN LIBRARY </span></h2>
		...
		<div class="copyright">
			<p>Copyright 2022 UiTM JASIN MELAKA. Library System.</p>
		</div>
		...
		<script type="text/javascript">
			...
			var typed = new Typed(".typing", {
				...
				strings: ["Welcome","Library System","Please Register Account To Continue"],
				typeSpeed: 100,
				backSpeed: 60,
				loop: true
			});
